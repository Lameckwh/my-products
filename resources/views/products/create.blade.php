...
@section('content')
    <div class="max-w-2xl">
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-semibold mt-2">New Product</h1>
        </div>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                                  class="w-full border rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-red-500 @error('description') border-red-400 @else border-gray-300 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
